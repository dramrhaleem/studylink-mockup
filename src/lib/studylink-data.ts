...
import { BookMarked, FileText, Microscope, BookOpen, type LucideIcon } from 'lucide-react'
...
/* أيقونات lucide لا إيموجي: الإيموجي يُرسَم بخط النظام فيختلف شكلًا ولونًا
   بين أندرويد وiOS، أي أنه لون خارج لوحة البراند لا يمكن ضبطه. */
...
export const stores: { name: StoreType; Icon: LucideIcon }[] = [
  { name: "هارفرد", Icon: BookOpen },
  { name: "برلين", Icon: BookMarked },
];
...
export const products: Product[] = [
  ...
  // تشريح - الفرقة الأولى
  { id: "p8", title: "تشريح - أطلس تشريحي ملون", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. نورهان السيد", subject: "تشريح", year: "الفرقة الأولى", price: 50, pages: 60, paperSize: "A3", image: asset('/products/anatomy-notes.png'), available: true, week: 1, description: "أطلس تشريحي ملون بالكامل يغطي جميع أجزاء الجسم مع رسومات توضيحية عالية الدقة" },
  { id: "p8b", title: "تشريح - شرح نظري الأسبوع الأول", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. نورهان السيد", subject: "تشريح", year: "الفرقة الأولى", price: 38, pages: 44, paperSize: "A4", image: asset('/products/anatomy-notes.png'), available: true, week: 1, description: "شرح تفصيلي للتشريح العضلي والعظمي مع رسومات توضيحية" },
  ...
  { id: "p8d", title: "تشريح - MCQs + بنك أسئلة", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. نورهان السيد", subject: "تشريح", year: "الفرقة الأولى", price: 22, pages: 26, paperSize: "A4", image: asset('/products/anatomy-notes.png'), available: true, week: 2, description: "بنك أسئلة تشريح شامل مع إجابات محلولة وشرح لكل سؤال" },
  { id: "p8e", title: "باقة تشريح الفرقة الأولى الكاملة", store: "هارفرد", category: "محاضرات", doctor: "د. نورهان السيد", subject: "تشريح", year: "الفرقة الأولى", price: 120, originalPrice: 150, pages: 152, paperSize: "A4", image: asset('/products/anatomy-notes.png'), available: true, isBundle: true, bundleCount: 5, week: 1, description: "باقة شاملة لكل محاضرات التشريح: شرح نظري + ورق عملي + MCQs + ملخصات" },

  // فسيولوجي - الفرقة الأولى
  { id: "p7", title: "فسيولوجي - محاضرات مراجعة شاملة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. خالد إبراهيم", subject: "فسيولوجي", year: "الفرقة الأولى", price: 38, pages: 44, paperSize: "A4", image: asset('/products/lectures.png'), available: true, week: 1, description: "مراجعة شاملة لفسيولوجي الجسم البشري مع أمثلة سريرية" },
  { id: "p7b", title: "فسيولوجي - كتاب مرجعي", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. خالد إبراهيم", subject: "فسيولوجي", year: "الفرقة الأولى", price: 55, pages: 80, paperSize: "A4", image: asset('/products/lectures.png'), available: true, week: 2, description: "كتاب مرجعي مفصل في علم وظائف الأعضاء مع رسومات بيانية" },
  ...
  { id: "p10", title: "باثولوجي - ملخص الفاينال", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. منى عبدالله", subject: "باثولوجي", year: "الفرقة الأولى", price: 42, originalPrice: 55, pages: 52, paperSize: "A4", image: asset('/products/pathology.png'), available: true, week: 1, description: "ملخص شامل لباثولوجي الفرقة الأولى مركز على أسئلة الفاينال" },
  ...
  { id: "p10c", title: "باثولوجي - MCQs + نموذج إجابات", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. منى عبدالله", subject: "باثولوجي", year: "الفرقة الأولى", price: 25, pages: 30, paperSize: "A4", image: asset('/products/pathology.png'), available: true, week: 1, description: "أسئلة باثولوجي متنوعة مع إجابات مفصلة" },
  ...
  { id: "p21", title: "تشريح - الأعصاب والرأس", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. نورهان السيد", subject: "تشريح", year: "الفرقة الثانية", price: 40, pages: 48, paperSize: "A4", image: asset('/products/anatomy-notes.png'), available: true, week: 1, description: "شرح تشريح الجهاز العصبي المركزي والمحيطي مع رسومات توضيحية" },
  ...
  { id: "p10e", title: "باثولوجي - MCQs الفرقة الثانية", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. منى عبدالله", subject: "باثولوجي", year: "الفرقة الثانية", price: 28, pages: 34, paperSize: "A4", image: asset('/products/pathology.png'), available: true, week: 1, description: "أسئلة باثولوجي للفرقة الثانية مع شرح مفصل" },
  ...
  // أدوية - الفرقة الثانية
  { id: "p9", title: "أدوية - تصنيف الأدوية", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد رضا", subject: "أدوية", year: "الفرقة الثانية", price: 28, pages: 28, paperSize: "A4", image: asset('/products/pharmacology.png'), available: true, week: 1, description: "تصنيف شامل للأدوية حسب المجموعات الدوائية مع جرعات" },
  { id: "p9b", title: "أدوية - MCQs", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد رضا", subject: "أدوية", year: "الفرقة الثانية", price: 22, pages: 30, paperSize: "A4", image: asset('/products/pharmacology.png'), available: true, week: 1, description: "أسئلة أدوية متنوعة مع حلول وشرح" },
  { id: "p9c", title: "أدوية - كتاب مرجعي", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد رضا", subject: "أدوية", year: "الفرقة الثانية", price: 48, pages: 90, paperSize: "A4", image: asset('/products/pharmacology.png'), available: true, week: 2, description: "كتاب مرجعي شامل في علم الأدوية" },
  ...
  { id: "p1", title: "محاضرات الجراحة العامة — الجزء الأول", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد سمير", subject: "جراحة عامة", year: "الفرقة الثالثة", price: 40, pages: 48, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "محاضرات جراحة عامة شاملة - الجزء الأول: مبادئ الجراحة والتعقيم" },
  { id: "p3", title: "جراحة عامة - ورق عملي", contentType: "ورق عملي", store: "هارفرد", category: "محاضرات", doctor: "د. سارة حسن", subject: "جراحة عامة", year: "الفرقة الثالثة", price: 30, pages: 24, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "ورق عملي جراحة مع حالات وتمارين تطبيقية" },
  { id: "p1b", title: "جراحة عامة - شرح نظري الأسبوع الثاني", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد سمير", subject: "جراحة عامة", year: "الفرقة الثالثة", price: 42, pages: 50, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 2, description: "الجراحة العامة - الجزء الثاني: جراحة البطن والصدر" },
  ...
  { id: "p11", title: "باقة الجراحة كاملة — 4 مذكرات", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد سمير", subject: "جراحة عامة", year: "الفرقة الثالثة", price: 120, originalPrice: 145, pages: 120, paperSize: "A4", image: asset('/products/surgery.png'), available: true, isBundle: true, bundleCount: 4, week: 1, description: "باقة جراحة عامة كاملة: شرح نظري + ورق عملي + MCQs + ملخصات" },
  { id: "p1f", title: "جراحة عامة - كتاب مرجعي", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. أحمد سمير", subject: "جراحة عامة", year: "الفرقة الثالثة", price: 65, pages: 110, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 3, description: "مرجع جراحة عامة شامل للفرقة الثالثة" },

  // أطفال - الفرقة الثالثة
  { id: "p6", title: "ملخصات الأطفال + بنك الأسئلة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. فاطمة أحمد", subject: "أطفال", year: "الفرقة الثالثة", price: 100, originalPrice: 120, pages: 36, paperSize: "A4", image: asset('/products/pediatrics.png'), available: true, isBundle: true, bundleCount: 4, week: 1, description: "باقة أطفال كاملة: ملخصات + شرح + أسئلة + ورق عملي" },
  { id: "p6b", title: "أطفال - شرح نظري", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. فاطمة أحمد", subject: "أطفال", year: "الفرقة الثالثة", price: 35, pages: 40, paperSize: "A4", image: asset('/products/pediatrics.png'), available: true, week: 1, description: "شرح نظري طب الأطفال مع حالات سريرية" },
  ...
  { id: "p4", title: "باطنة - شرح نظري متقدم", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. محمد علي", subject: "باطنة", year: "الفرقة الرابعة", price: 45, pages: 56, paperSize: "A4", image: asset('/products/medicines.png'), available: true, week: 1, description: "شرح نظري متقدم للباطنة الإكلينيكية مع حالات" },
  { id: "p5", title: "باطنة - أسئلة MCQs", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. محمد علي", subject: "باطنة", year: "الفرقة الرابعة", price: 30, pages: 40, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, week: 2, description: "أسئلة باطنة متقدمة للفرقة الرابعة" },
  { id: "p4b", title: "باطنة - كتاب مرجعي", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. محمد علي", subject: "باطنة", year: "الفرقة الرابعة", price: 65, pages: 120, paperSize: "A4", image: asset('/products/medicines.png'), available: true, week: 1, description: "كتاب مرجعي شامل في الباطنة للفرقة الرابعة" },
  ...
  { id: "p4d", title: "باطنة - ملخص سريع للفاينال", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. محمد علي", subject: "باطنة", year: "الفرقة الرابعة", price: 35, originalPrice: 45, pages: 30, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, week: 4, description: "ملخص سريع مركز على أسئلة الفاينال" },

  // جراحة عامة - الفرقة الرابعة
  { id: "p23", title: "جراحة عامة - شرح نظري الفرقة الرابعة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. أمل السعيد", subject: "جراحة عامة", year: "الفرقة الرابعة", price: 42, pages: 52, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "جراحة عامة متقدمة للفرقة الرابعة" },
  ...
  { id: "p16", title: "نسا وتوليد - شرح نظري", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. هالة محمود", subject: "نسا وتوليد", year: "الفرقة الرابعة", price: 42, pages: 52, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "شرح نظري شامل لطب النساء والتوليد" },
  ...
  { id: "p16d", title: "نسا وتوليد - كتاب مرجعي", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. هالة محمود", subject: "نسا وتوليد", year: "الفرقة الرابعة", price: 58, pages: 95, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 3, description: "كتاب مرجعي في النساء والتوليد" },

  // أطفال - الفرقة الرابعة
  { id: "p24", title: "أطفال - شرح نظري الفرقة الرابعة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. عمر فاروق", subject: "أطفال", year: "الفرقة الرابعة", price: 38, pages: 46, paperSize: "A4", image: asset('/products/pediatrics.png'), available: true, week: 1, description: "شرح أطفال متقدم للفرقة الرابعة" },
  ...
  { id: "p30", title: "باطنة - شرح نظري الفرقة الخامسة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة الخامسة", price: 45, pages: 58, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, week: 1, description: "باطنة متقدمة: أمراض القلب والجهاز التنفسي" },
  { id: "p30b", title: "باطنة - MCQs الفرقة الخامسة", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة الخامسة", price: 30, pages: 38, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, week: 2, description: "أسئلة باطنة متقدمة للفرقة الخامسة مع حلول" },
  ...
  { id: "p30d", title: "باطنة - كتاب مرجعي الفرقة الخامسة", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة الخامسة", price: 70, originalPrice: 85, pages: 130, paperSize: "A4", image: asset('/products/medicines.png'), available: true, week: 1, description: "مرجع باطنة متقدم للفرقة الخامسة" },
  { id: "p30e", title: "باقة باطنة الفرقة الخامسة الكاملة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة الخامسة", price: 130, originalPrice: 165, pages: 248, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, isBundle: true, bundleCount: 5, week: 1, description: "باقة باطنة الخامسة كاملة: كل المذكرات في باقة واحدة" },

  // جراحة عامة - الفرقة الخامسة
  { id: "p31", title: "جراحة عامة - شرح نظري الفرقة الخامسة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. إيمان الشافعي", subject: "جراحة عامة", year: "الفرقة الخامسة", price: 42, pages: 54, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "جراحة متقدمة: جراحة الأوعية والصدر" },
  { id: "p31b", title: "جراحة عامة - MCQs الفرقة الخامسة", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. إيمان الشافعي", subject: "جراحة عامة", year: "الفرقة الخامسة", price: 28, pages: 34, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 2, description: "أسئلة جراحة متقدمة مع حلول" },
  ...
  { id: "p32", title: "نسا وتوليد - شرح نظري الفرقة الخامسة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. رانيا عادل", subject: "نسا وتوليد", year: "الفرقة الخامسة", price: 40, pages: 50, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "نسا وتوليد متقدم: الأمراض النسائية وطب التوليد" },
  ...
  { id: "p40", title: "باطنة - شرح نظري الفرقة السادسة (ماستر)", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة السادسة", price: 50, pages: 62, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, week: 1, description: "باطنة الفرقة السادسة: أمراض الكلى والجهاز الهضمي والغدد" },
  { id: "p40b", title: "باطنة - MCQs الفرقة السادسة", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة السادسة", price: 32, pages: 40, paperSize: "A4", image: asset('/products/internal-medicine.png'), available: true, week: 2, description: "أسئلة باطنة سادسة مع حلول تفصيلية" },
  { id: "p40c", title: "باطنة - ملخص ماستر الفاينال", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة السادسة", price: 55, originalPrice: 70, pages: 48, paperSize: "A4", image: asset('/products/medicines.png'), available: true, week: 3, description: "ملخص ماستر باطنة مركز على الفاينال" },
  { id: "p40d", title: "باطنة - كتاب مرجعي الفرقة السادسة", contentType: "كتب", store: "هارفرد", category: "محاضرات", doctor: "د. حسام الدين", subject: "باطنة", year: "الفرقة السادسة", price: 75, pages: 140, paperSize: "A4", image: asset('/products/medicines.png'), available: true, week: 1, description: "مرجع باطنة شامل للفرقة السادسة" },

  // جراحة عامة - الفرقة السادسة
  { id: "p41", title: "جراحة عامة - شرح نظري الفرقة السادسة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. إيمان الشافعي", subject: "جراحة عامة", year: "الفرقة السادسة", price: 45, pages: 56, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "جراحة عامة الفرقة السادسة: جراحة متخصصة" },
  { id: "p41b", title: "جراحة عامة - MCQs الفرقة السادسة", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. إيمان الشافعي", subject: "جراحة عامة", year: "الفرقة السادسة", price: 30, pages: 36, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 2, description: "أسئلة جراحة سادسة مع حلول" },
  ...
  { id: "p41d", title: "باقة جراحة الفرقة السادسة الكاملة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. إيمان الشافعي", subject: "جراحة عامة", year: "الفرقة السادسة", price: 140, originalPrice: 180, pages: 200, paperSize: "A4", image: asset('/products/surgery.png'), available: true, isBundle: true, bundleCount: 4, week: 1, description: "باقة جراحة سادسة كاملة" },

  // نسا وتوليد - الفرقة السادسة
  { id: "p42", title: "نسا وتوليد - شرح نظري الفرقة السادسة", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. رانيا عادل", subject: "نسا وتوليد", year: "الفرقة السادسة", price: 42, pages: 52, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 1, description: "نسا وتوليد الفرقة السادسة: حالات متقدمة" },
  { id: "p42b", title: "نسا وتوليد - MCQs الفرقة السادسة", contentType: "أسئلة MCQs", store: "هارفرد", category: "محاضرات", doctor: "د. رانيا عادل", subject: "نسا وتوليد", year: "الفرقة السادسة", price: 28, pages: 34, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 2, description: "أسئلة نسا وتوليد متقدمة مع حلول" },
  { id: "p42c", title: "نسا وتوليد - ملخص ماستر", contentType: "شرح نظري", store: "هارفرد", category: "محاضرات", doctor: "د. رانيا عادل", subject: "نسا وتوليد", year: "الفرقة السادسة", price: 38, originalPrice: 50, pages: 40, paperSize: "A4", image: asset('/products/surgery.png'), available: true, week: 3, description: "ملخص نسا وتوليد للماستر" },
  ...
  // فسيولوجي - برلين
  { id: "p14", title: "فسيولوجي - ملخص سريع", contentType: "شرح نظري", store: "برلين", category: "محاضرات", doctor: "د. خالد إبراهيم", subject: "فسيولوجي", year: "الفرقة الأولى", price: 32, pages: 30, paperSize: "A4", image: asset('/products/lectures.png'), available: true, week: 1, description: "ملخص فسيولوجي سريع من مكتبة برلين" },
  ...
  // ─── أدوات طبية ───
  // ═══════════════════════════════════════════════════════════════════
  { id: "t1", title: "سماعة ليتمان كلاسيك III", store: "هارفرد", category: "أدوات طبية", price: 850, specs: "ألومنيوم | من المورّد المعتمد", image: asset('/products/stethoscope-pro.png'), available: true, description: "سماعة ليتمان كلاسيك III — مصدرها المكتبة الشريكة، وحالتها مكتوبة في وصف المنتج" },
...
export function getDescription(product: Product): string {
  ...
  if (product.category === 'أدوات طبية') {
    return 'أداة طبية من المكتبة الشريكة — المواصفات وحالة التوفّر مكتوبة أعلاه'
  }

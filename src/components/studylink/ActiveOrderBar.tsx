 ...
 *
 * الغرض: الطالب الذي عنده طلب شغّال لا يجب أن يبحث عنه. الشريط يجلس تحت
 * البانرات مباشرة ويعرض المرحلة الحالية وخطًا زمنيًا يتقدّم، ومدخلين: التتبع
 * الكامل، والتواصل مع الدعم.
 *
 * ⚠️ **ليس لاصقًا (`sticky`) عمدًا.** جُرّب لاصقًا فبدا وكأنه «ينزل مع المستخدم»
 * ويزاحم محتوى الصفحة طوال التمرير. القرار: يبقى في مكانه ويمرّ منه المستخدم
 * كأي بطاقة أخرى.
 *

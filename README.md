...
> **مستلم المشروع لأول مرة؟** ابدأ من **[`HANDOFF.md`](HANDOFF.md)** — نقطة
> الدخول الوحيدة: أول ١٠ دقائق، مصادر الحقيقة، القواعد الملزمة، ما هو مؤجَّل،
> والقرارات التي تحتاج المؤسس قبل البناء.
>
